...
if (loading) return (
  <div className="flex justify-center items-center h-screen">
   ...
   return auth ? null  : (
       ...
       <div className="min-h-full w-full flex flex-col items-center pt-6
      px-4 relative bg-gradient-to-b from-blue-50 to-gray-100">
      ...
      <div className="w-full max-w-md text-center mb-6">
        ...
        <h1 className="text-3xl font-bold text-black drop-shadow-md mt-2">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-5">
        <form onSubmit={formik.handleSubmit}>
            ...
            {signUp && (
              <div>
                ...
                <input  type="text" name="name" placeholder="Your name"
                  ...
                  className="w-full p-2.5 mt-1 rounded-lg border border-gray-300
            ...
            <div className="relative">
              ...
              <input type={showPassword ? 'text' : 'password'}  name="password"
               placeholder="Enter password"  onChange={formik.handleChange}
                ...
                className="w-full p-2.5 mt-1 pr-10 rounded-lg border border-gray-300 focus:ring-2
                 focus:ring-black outline-none transition"
              />
          ...
          <p className="text-center text-gray-700 mt-4">
            ...
            <span className="text-[#17186C] font-semibold cursor-pointer"
